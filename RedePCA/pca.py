...
def main():
	...
	plt.bar(range(1,14), eig_vals_norm, alpha=0.5, align='center', label='Contribuição individual')
	plt.step(range(1,14), np.cumsum(eig_vals_norm), where='mid', label='Contribuição acumulada')
	plt.legend(loc='best')
